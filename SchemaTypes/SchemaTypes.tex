...
Applying the IH gives $$\Sigma,\zeta',\zeta \vdash \kappa$$ $$\Sigma,\zeta',\zeta \vdash \kappa'$$ $$\sem{\Sigma,\zeta',\zeta \vdash \kappa} = f^*\sem{\Sigma,\zeta,\zeta' \vdash \kappa}$$ $$\sem{\Sigma,\zeta',\zeta \vdash \kappa} = f^*\sem{\Sigma,\zeta,\zeta' \vdash \kappa} $$
Applying the exchange lemma for coeffect well-formedness judgments gives $$\Sigma,\zeta',\zeta \vdash A$$ $$\sem{\Sigma,\zeta',\zeta \vdash A} = f^*\sem{\Sigma,\zeta,\zeta' \vdash A} $$

Applying \begin{sc}KWF-TyFun\end{sc} gives $\Sigma,\zeta',\zeta \vdash \kappa \overset{A}{\Rightarrow} \kappa'$. Furthermore, we have\\~\\
$= (f^* \sem{\Sigma,\zeta,\zeta' \vdash \kappa \overset{A}{\Rightarrow} \kappa'})_\sigma$\\~\\
$= \sem{\Sigma,\zeta,\zeta' \vdash \kappa \overset{A}{\Rightarrow} \kappa'}_{f(\sigma)}$\\~\\
$= D_{\Sigma,\zeta,\zeta'} A(\sem{\Sigma,\zeta,\zeta' \vdash \kappa})_{f(\sigma)} \Rightarrow \sem{\Sigma,\zeta,\zeta' \vdash \kappa'}_{f(\sigma)}$\\~\\
$= \sem{\Sigma,\zeta,\zeta' \vdash \kappa}_{f(\sigma)} \times \sem{\Sigma,\zeta,\zeta' \vdash A}_{f(\sigma)} \Rightarrow \sem{\Sigma,\zeta,\zeta' \vdash \kappa'}_{f(\sigma)}$\\~\\
$= (f^* \sem{\Sigma,\zeta,\zeta' \vdash \kappa})_\sigma \times (f^*\sem{\Sigma,\zeta,\zeta' \vdash A})_{\sigma} \Rightarrow (f^* \sem{\Sigma,\zeta,\zeta' \vdash \kappa'})_\sigma$\\~\\
$= \sem{\Sigma,\zeta',\zeta \vdash \kappa}_\sigma \times \sem{\Sigma,\zeta',\zeta \vdash A}_{\sigma} \Rightarrow \sem{\Sigma,\zeta',\zeta \vdash \kappa'}_\sigma$\\~\\
$= D_{\Sigma,\zeta',\zeta} A(\sem{\Sigma,\zeta',\zeta \vdash \kappa})_\sigma \Rightarrow \sem{\Sigma,\zeta',\zeta \vdash \kappa'}_\sigma$\\~\\
$\sem{\Sigma,\zeta',\zeta \vdash \kappa \overset{A}{\Rightarrow} \kappa'}$\\
