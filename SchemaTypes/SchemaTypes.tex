...
\begin{tabular}{lll}
$\sem{\Sigma \vdash \mathit{KString}(d,\phi)}$ & $\doteq \sdisp{~(\mathcal P(X_\sigma), \subseteq)~}_{\sigma \in \sem{\Sigma}}$ & $\text{where } X_\sigma \doteq \{ f \in \mathit{Inst} \mid f(\epsilon) \in \sem{\Sigma \vdash d}_\sigma$ \\
 & &~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$\wedge~\mathit{chars}(f(\epsilon)) \subseteq \phi \}$ \\
